...
ALTER TABLE obsahuje
    ADD CONSTRAINT pk_obsahuje UNIQUE ( material,
                                        material1,
                                        zakazka );
...
ALTER TABLE obsahuje
    ADD CONSTRAINT fk_obsahuje_material FOREIGN KEY ( material,
                                                      material1 )
